...
import baseball.domain.number.NumbersFactory;
import java.util.List;

public class BaseBallGame {

    public GuessResult guess(List<Integer> selectedNumbers, String inputNumbers) {
        Numbers hostNumbers = NumbersFactory.convert(selectedNumbers);
        Numbers clientNumbers = NumbersFactory.convert(inputNumbers);
